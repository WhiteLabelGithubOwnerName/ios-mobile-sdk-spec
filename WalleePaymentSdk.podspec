Pod::Spec.new do |s|
  ...
  s.version      = "1.4.release-candidate-1.3.0-preinstall-script-fix-2"
  ...
  s.source       = { :git => "https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk.git", :tag => "1.4.release-candidate-1.3.0-preinstall-script-fix-2" }
