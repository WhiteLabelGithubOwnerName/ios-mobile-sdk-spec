Pod::Spec.new do |s|
  ...
  s.version      = "1.4.61ecf8a68a2f380eb2b69f43409f74ba0a1b4d29"
  ...
  s.source       = { :git => "https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk.git", :tag => "1.4.61ecf8a68a2f380eb2b69f43409f74ba0a1b4d29" }
