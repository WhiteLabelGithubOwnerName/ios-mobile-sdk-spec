...
target 'DemoApp' do
  ...
  pod ‘WalleePaymentSdk’, '7.0.0.noFirebase-Static-framework'
...
`pod 'WalleePaymentSdk', '7.0.0.noFirebase-Static-framework', :source=> 'https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk.git'`
