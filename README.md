...
target 'DemoApp' do
  ...
  pod ‘WalleePaymentSdk’, '1.4.1de76edba73b46807d23836be70a1b0ff9418f9d-2-no-firebase'
...
`pod 'WalleePaymentSdk', '1.4.1de76edba73b46807d23836be70a1b0ff9418f9d-2-no-firebase', :source=> 'https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk.git'`
