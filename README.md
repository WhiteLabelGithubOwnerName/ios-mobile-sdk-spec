...
target 'DemoApp' do
  ...
  pod ‘WalleePaymentSdk’, '1.4.release-candidate-1.3.0-preinstall-script-fix-3'
...
`pod 'WalleePaymentSdk', '1.4.release-candidate-1.3.0-preinstall-script-fix-3', :source=> 'https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk.git'`
