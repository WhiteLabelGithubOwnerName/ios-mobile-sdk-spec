...
target 'DemoApp' do
  ...
  pod ‘WalleePaymentSdk’, '1.4.1122334455'
...
`pod 'WalleePaymentSdk', '1.4.1122334455', :source=> 'https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk.git'`

and

`pod 'PaymentResources', '2.0.0'`
