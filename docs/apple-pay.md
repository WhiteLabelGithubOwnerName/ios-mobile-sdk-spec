...
The final step is setting up the Merchant ID in SDK configuration. To do so, please call the `walleePaymentSdk.configureApplePay(merchantId: "merchant.your.id")` method with the relevant Merchant ID.
