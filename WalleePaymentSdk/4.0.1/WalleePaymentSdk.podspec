Pod::Spec.new do |s|
  ...
  s.version      = "4.0.1"
  s.summary      = "https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk-spec#readme"
  ...
  s.source       = { :git => "https://github.com/WhiteLabelGithubOwnerName/ios-mobile-sdk.git", :tag => "4.0.1" }
